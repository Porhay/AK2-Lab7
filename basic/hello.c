...
MODULE_AUTHOR("Denys Mitiachkin <denismityachkin@gmail.com>");
...
MODULE_PARM_DESC(times, "How many times to print Hello World");
...
if (times == 0)
	pr_info("Time is 0 because no printing was used\n");
